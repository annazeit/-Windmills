...
public class Player : MonoBehaviour
{
    ...
    public KeyCode MoveForwardKeyCode = KeyCode.None;
    public KeyCode MoveBackwardKeyCode = KeyCode.None;
    public KeyCode MoveRightKeyCode = KeyCode.None;
    public KeyCode MoveLeftKeyCode = KeyCode.None;
